...
export default function LocationBox(props) {
    ...
    return (
        <div key={location._id} className='card' style={{ left: "0", height: "204px", width: "320px", paddingTop:"5px" }}>
            ...
            <Link to={`/destination/${location._id}`} style={{ fontSize: "14px" }}>{location.city}</Link>
            <div className="card-text" style={{ fontSize: "12px" }}>
                <span class="icon"><i class="fas fa-map-marker-alt" style={{ fontSize: "1rem" }}></i></span>
